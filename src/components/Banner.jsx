...
const Banner = () => {
  return (
    <div className='w-full md:h-4/6 relative flex flex-col justify-center items-center md:gap-4 mt-12 lg:mt-32 py-8'>
        <h1 className='text-[2.5em] font-bold md:text-[5em] lg:text-[7.5em] md:font-normal text-white font-inter text-center'>
          Harsh Pratap Singh
        </h1>
        <h2 className='text-center text-xl md:text-2xl lg:text-3xl text-[#A1A1A1] text-[2.5rem] font-inter font-light'>
