...
const Projects = (props,project) => {
  ...
  return (
    <div className='project h-full text-white px-4 md:px-[5rem] py-[7.5rem]'>
        <motion.div className='grid grid-cols-1 lg:grid-cols-2 auto-rows-auto xl:grid-cols-3 gap-9 justify-end items-center' ref={ref}
        variants={animation}
        initial="hidden"
        animate={mainControls}>
            <div className='col-span-1 lg:col-span-2 xl:col-span-3 flex flex-col justify-center items-start' ref={project}            
            >
